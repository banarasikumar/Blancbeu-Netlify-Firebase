...
function handlePointerStart(event) {
        ...
        // Speed control disabled - using fixed 60% speed
...
function handlePointerMove(event) {
        ...
        // Speed control removed - using fixed 60% speed
        // if (isUpdatingSpeed) {
...
const soundManager = {
        ...
        playSound(type, scale=1) {
                ...
                // Disallow starting new sounds if sound is disabled or paused.
                // Speed check removed to allow sounds at 60% default speed
